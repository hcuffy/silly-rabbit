...
describe("DELETE /session-recordings/:id auto-cancels a RUNNING nested SessionReplayRun before " +
  ...
  it("DELETE /session-recordings/:id on a recording with one RUNNING nested SessionReplayRun " +
    "stops the real chromium instance, catches the doomed step's Finding in the cascade (not " +
    "orphaned afterward), and cleanly removes the recording + run + finding", async () => {
