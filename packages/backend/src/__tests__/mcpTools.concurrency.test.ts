...
describe(
  "MCP trigger_charter_run concurrency cap (RESOURCE EXHAUSTION audit fix) — same shared cap " +
  ...
  () => {
    ...
    it(
      "rejects the 2nd of 2 rapid-fire triggers with isError:true while the 1st proceeds, then accepts " + "a 3rd once the 1st completes",
      async () => {
